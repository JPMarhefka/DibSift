...
function buildAnalysisPrompt(goal, listings) {
  ...
  return [
    ...
    "* Suggested opening offer should be below the asking price when an asking price is known.",
    "* Max price should be the highest price I should pay, usually at or below asking price.",
    "",
    ...
    "Give detailed notes for the top 3 to 5 listings only, including why each ranked highly, what to verify, negotiation advice, and a short Facebook Marketplace message I can send. The message must be addressed to the seller, include the suggested offer amount, and include 1 to 2 important verification questions.",
    "",
    "Step 6: Final answer",
